...
from keras.layers import (Add, Concatenate, Conv1D, Layer, MaxPooling1D,
...
# ---------------------------------------------------#
#   卷积块 -> 卷积 + 标准化 + 激活函数
#   DarknetConv1D + BatchNormalization + Mish
# ---------------------------------------------------#
def DarknetConv1D_BN_Mish(*args, **kwargs):
...
# --------------------------------------------------------------------#
#   CSPdarknet的结构块
#   首先利用ZeroPadding1D和一个步长为2x2的卷积块进行高和宽的压缩
...
# ---------------------------------------------------#
def darknet_body(x):
    x = DarknetConv1D_BN_Mish(32, 3)(x)
